        ...
        <div class="card-body">
            <form method="get" action="/admin/products">
                <div class="form-group row">
                    <label class="col-3 col-lg-2 col-form-label text-right">Loại</label>
            ...
            <div class="card-header">Sản phẩm
                <div class="tools dropdown">
                    ...
                    <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="/admin/products/create">Thêm</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody class="no-border-x">
                        ...
                        <?php foreach ($data as $item) : ?>
                            <tr>
                                ...
                                <td><label> <?= $item['namect']; ?> </label></td>
                                <td><label> <?php if($item['quantity'] == 0){ echo 'hết hàng';}else{ echo $item['quantity'];} ?> </label></td>
                                ...
                                <td style="width:60px" class="actions"><a class="btn btn-primary btn-sm" href="/admin/products/edit?id=<?= $item['id']?>">Sửa</a></td>
                            </tr>
                            <?php $i++ ?>
                        <?php endforeach ?>
                    </tbody>
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <div class="mt-8">
                        ...
                        <a href="/admin/products/destroy?id=<?= $item['id'] ?>" class="btn btn-space btn-danger" >Đồng ý</a>
                    </div>
                </div>
            </div>
