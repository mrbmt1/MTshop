    ...
    <div class="col-12">
        <div class="card card-border-color card-border-color-primary">
            ...
            <div class="card-body">
                ...
                <form action="/admin/products/edit?id=<?= $data->id ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->price ?>" class="form-control form-control-sm" type="text" name="price">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-form-label mb-2">Sale</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->sale ?>" class="form-control form-control-sm" type="text" min=0 name="sale">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-form-label mb-2">Số lượng</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->quantity ?>" class="form-control form-control-sm" type="text" name="quantity">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <select data-placeholder="Loại" class="chosen-select" name="category_id" style="width: 160px">
                                <?php foreach ($category_id as $value) { ?>
                                    <option value="<?php echo $value->id ?>" <?php if($categories->id === $value->id) { echo "selected"; }?> ><?= $value->name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
