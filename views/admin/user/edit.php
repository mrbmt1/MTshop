    ...
    <div class="col-12">
        <div class="card card-border-color card-border-color-primary">
            ...
            <div class="card-body">
                ...
                <form action="/admin/user/edit?id=<?= $data->id ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->email ?>" class="form-control form-control-sm" type="email" name="email" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-form-label mb-2">Số điện thoại</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input value="<?= $data->phone ?>" class="form-control form-control-sm" type="number" name="phone" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-12 col-form-label mb-2">Role</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <select class="form-control select2 select2-sm" name="role">
                                <option value="1" <?= $data->role == 1 ? "selected" : ""?>>Admin</option>
                                <option value="2" <?= $data->role == 2 ? "selected" : ""?>>Quản trị viên</option>
